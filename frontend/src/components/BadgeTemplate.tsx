  ...
  return (
    <div className="fixed bottom-4 left-4 flex items-center space-x-2">
      ...
      <div ref={qrCodeRef} style={{ position: 'absolute', top: '-1000px', left: '-1000px' }}>
        <QRCode value={`https://hackathon-website.fly.dev/checkin/${userId}`} size={300} />
      </div>
